module CurationsHelper
  ...
  def dosage_summary_link(type, gene_record)
    ...
    #  "".html_safe + assertion[:short_label]
      ("<a class='btn btn-success btn-xs watchreportclick' title='Click Gene Dosage Report' target='file' href='https://dosage.clinicalgenome.org/clingen_gene.cgi?sym=" + gene_record[:symbol] + "&subject'> " + assertion[:short_label] + "</a>").html_safe
